...
CROP_THUMBNAILS_VUE.components.loadingcontainer = {
	template: "<div> {{status}} <img :src=\"image\" style=\"display:none;\"/><slot></slot></div>",
	props:{
		image : {
			required: true,
			type:String
